...
namespace _Playable.Runtime.Core
{
    ...
    public static class PlayableTween
    {
        ...
        public static IEnumerator Scale(Transform target, [Bridge.Ref] Vector3 to, float duration, Func<float, float> ease = null)
        {
            if (target == null)
            {
                yield break;
        ...
        public static IEnumerator PopIn(Transform target, [Bridge.Ref] Vector3 to, float duration)
        {
            if (target == null)
            {
                yield break;
        ...
        public static IEnumerator MoveLocal(Transform target, [Bridge.Ref] Vector3 to, float duration,
            Func<float, float> ease = null)
        {
            if (target == null)
            {
        ...
        public static IEnumerator MoveAnchored(RectTransform target, [Bridge.Ref] Vector2 to, float duration,
            Func<float, float> ease = null)
        {
            if (target == null)
            {
        ...
        public static IEnumerator MoveAnchoredBy(RectTransform target, [Bridge.Ref] Vector2 delta, float duration,
            Func<float, float> ease = null)
        {
            if (target == null)
            {
        ...
        /// </summary>
        public static IEnumerator LoopScale(Transform target, [Bridge.Ref] Vector3 baseScale, float delta, float halfDuration)
        {
            if (target == null)
            {
                yield break;
        ...
        public static IEnumerator LoopMove(RectTransform target, [Bridge.Ref] Vector2 basePosition, [Bridge.Ref] Vector2 delta,
            float halfDuration)
        {
            if (target == null)
            {
