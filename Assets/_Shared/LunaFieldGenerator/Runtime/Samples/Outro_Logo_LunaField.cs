...
namespace LunaField
{
    public class Outro_Logo_LunaField : FieldBase
    {
        [Header("Texture")]
        [LunaPlaygroundAsset("Texture", 0, "Outro_Logo")]
        public Texture2D tex = null;

        [Header("Phone Position")]
        [LunaPlaygroundField("Phone_Position_PT", 1, "Outro_Logo")]
        public Vector2 phone_Position_PT = Vector2.zero;
        [LunaPlaygroundField("Phone_Position_LS", 2, "Outro_Logo")]
        public Vector2 phone_Position_LS = Vector2.zero;

        [Header("Phone Scale")]
        [LunaPlaygroundField("Phone_Scale_PT", 3, "Outro_Logo")]
        public Vector2 phone_Scale_PT = Vector2.one;
        [LunaPlaygroundField("Phone_Scale_LS", 4, "Outro_Logo")]
        public Vector2 phone_Scale_LS = Vector2.one;

        [Header("Tablet Position")]
        [LunaPlaygroundField("Tablet_Position_PT", 11, "Outro_Logo")]
        public Vector2 tablet_Position_PT = Vector2.zero;
        [LunaPlaygroundField("Tablet_Position_LS", 12, "Outro_Logo")]
        public Vector2 tablet_Position_LS = Vector2.zero;

        [Header("Tablet Scale")]
        [LunaPlaygroundField("Tablet_Scale_PT", 13, "Outro_Logo")]
        public Vector2 tablet_Scale_PT = Vector2.one;
        [LunaPlaygroundField("Tablet_Scale_LS", 14, "Outro_Logo")]
