...
namespace LunaField
{
    public class Gameplay_Score_LunaField : FieldBase
    {
        [Header("Phone Position")]
        [LunaPlaygroundField("Phone_Position_PT", 0, "Gameplay_Score")]
        public Vector2 phone_Position_PT = Vector2.zero;
        [LunaPlaygroundField("Phone_Position_LS", 1, "Gameplay_Score")]
        public Vector2 phone_Position_LS = Vector2.zero;

        [Header("Tablet Position")]
        [LunaPlaygroundField("Tablet_Position_PT", 10, "Gameplay_Score")]
        public Vector2 tablet_Position_PT = Vector2.zero;
        [LunaPlaygroundField("Tablet_Position_LS", 11, "Gameplay_Score")]
        public Vector2 tablet_Position_LS = Vector2.zero;

        [Header("Phone Scale")]
        [LunaPlaygroundField("Phone_Scale_PT", 20, "Gameplay_Score")]
        public Vector2 phone_Scale_PT = Vector2.one;
        [LunaPlaygroundField("Phone_Scale_LS", 21, "Gameplay_Score")]
        public Vector2 phone_Scale_LS = Vector2.one;

        [Header("Tablet Scale")]
        [LunaPlaygroundField("Tablet_Scale_PT", 30, "Gameplay_Score")]
        public Vector2 tablet_Scale_PT = Vector2.one;
        [LunaPlaygroundField("Tablet_Scale_LS", 31, "Gameplay_Score")]
